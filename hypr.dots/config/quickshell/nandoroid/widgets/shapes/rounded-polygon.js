...
class RoundedPolygon {
    ...
    static fromNumVertices(numVertices, radius = 1, centerX = 0, centerY = 0, rounding = CornerRounding.CornerRounding.Unrounded, perVertexRounding = null) {
    ...
    static fromVertices(vertices, rounding = CornerRounding.CornerRounding.Unrounded, perVertexRounding = null, centerX = Number.MIN_SAFE_INTEGER, centerY = Number.MAX_SAFE_INTEGER) {
        const corners = []
    ...
    static rectangle(width, height, rounding = CornerRounding.CornerRounding.Unrounded, perVertexRounding = null, centerX = 0, centerY = 0) {
    ...
    static star(numVerticesPerRadius, radius = 1, innerRadius = .5, rounding = CornerRounding.CornerRounding.Unrounded, innerRounding = null, perVertexRounding = null, centerX = 0, centerY = 0) {
