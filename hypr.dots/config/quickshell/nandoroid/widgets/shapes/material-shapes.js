...
function arch() {
    return RoundedPolygon.RoundedPolygon.rectangle(1, 1, CornerRounding.CornerRounding.Unrounded, [cornerRound20, cornerRound20, cornerRound100, cornerRound100])
        .normalized();
}
...
function semiCircle() {
    return RoundedPolygon.RoundedPolygon.rectangle(1.6, 1, CornerRounding.CornerRounding.Unrounded, [cornerRound20, cornerRound20, cornerRound100, cornerRound100]).normalized();
}
...
class PointNRound {
    constructor(o, r = CornerRounding.CornerRounding.Unrounded) {
        this.o = o;
        this.r = r;
    }
}
...
function customPolygon(pnr, reps, center = new Offset.Offset(0.5, 0.5), mirroring = false) {
    ...
    return RoundedPolygon.RoundedPolygon.fromVertices(vertices, CornerRounding.CornerRounding.Unrounded, perVertexRounding, center.x, center.y);
}
